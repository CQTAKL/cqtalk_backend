package com.cqtalk.util.getid;

import org.springframework.stereotype.Component;

// 雪花算法
@Component   // 交给spring容器管理id生成器对象
...
//    }
    ...
    public synchronized long nextId() {
        ...
        // 移位并通过或运算拼到一起组成64位的ID
         ...
         String aStrSub = aStr.substring(0, 16);
         return Long.parseLong(aStrSub);
    }
...
//        SnowflakeIdWorker idWorker = new SnowflakeIdWorker(0, 0);
        ...
        idWorker.setWorkerIdAndDatacenterId(0,0);
        for (int i = 0; i < 10; i++) {
